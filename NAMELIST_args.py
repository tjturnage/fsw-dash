...
# commenting out following three lines just so I don't get errors when not in the proper environment
...
parser.add_argument("--isAnd", type=bool)
parser.add_argument("--byForecast", type=bool)
parser.add_argument("--isGrep", type=bool)

args = parser.parse_args()

new_word_list = [x.replace("_"," ") for x in args.word_list]
...
# =============================================================================
input_word_list = new_word_list #["Lake Breeze", "Lake Breezes", "Lakebreeze", "LAKE BREEZE", "LAKE BREEZES"]
...
# =============================================================================
    ...
    #list1.sort()
# =============================================================================
#forecast_product_list = ["AFDGRR","AFDAPX","AFDIWX","AFDLOT","AFDMQT","AFDDTX","AFDMKX","AFDGRB"] #Option.MASTER_LIST
forecast_product_list = args.product_list #["AFDGRR","AFDAPX","AFDIWX"] #Option.MASTER_LIST
...
#     Boolean: True/False
# =============================================================================
byForecast = args.byForecast #True
...
# commenting out following lines just so I don't get errors when not in the proper environment
